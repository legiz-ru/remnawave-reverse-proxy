---
title: Warp Native
description: Инструкция по установке и настройке Warp Native для связывания серверов
---
...
В секцию вашего конфигурационного профиля ноды, добавляется следующие блоки:
