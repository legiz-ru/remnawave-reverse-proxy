...
:::caution
This page is not available in English yet. You can help us translate it! Check out the [contribution guide](../../contribution/guide) to get started.
:::
...
4. Insert the following content:
    ...
    server {
        ...
        ssl_certificate "/etc/letsencrypt/live/yourdomain.com/fullchain.pem"; # Path to the certificate
        ssl_certificate_key "/etc/letsencrypt/live/yourdomain.com/privkey.pem"; # Path to the private key
        ssl_trusted_certificate "/etc/letsencrypt/live/yourdomain.com/fullchain.pem"; # Path to the certificate
